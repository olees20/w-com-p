...
export async function uploadDocument(params: { userId: string; businessId: string; file: File; healthCheckId: string }) {
  const { userId, businessId, file, healthCheckId } = params;
